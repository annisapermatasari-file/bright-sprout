...
export function LessonPlayer({
  ...
  if (isFinished) {
    ...
    return (
      <div className="lesson-finish-shell flex flex-col gap-4">
        <LearningBuddy state="finished" />
        <Card className="lesson-finish-card flex flex-col items-center gap-4 rounded-3xl py-10 text-center">
  ...
  return (
    <div className="child-play-shell game-board flex flex-col gap-6">
      ...
      <Card key={currentQuestion.id} className="play-question-card rounded-3xl">
        <ActivityRenderer
